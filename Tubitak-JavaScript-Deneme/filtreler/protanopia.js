...
filtreID.innerHTML = '<svg id="colorblind-filters" style="display: none"> <defs> <filter id="Protanopia"> <feColorMatrix type="matrix" values="1,0,0,0,0 0.8,-0.2,0,0,0 0,-0.2,1.3,0,0 0,0,0,1,0" in="SourceGraphic" /> </filter> </defs> </svg>';
