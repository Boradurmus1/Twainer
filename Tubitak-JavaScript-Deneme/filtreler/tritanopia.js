//Filtrelerin üst üste binmmesini önlemek için eğer varsa daha önceden seçili olan filtrenin kaldırılması sağlanmıştır
try {
...
filtreID.innerHTML = '<svg id="colorblind-filters" style="display: none"> <defs> <filter id="Tritanopia"> <feColorMatrix type="matrix" values="1,0,-0.2,0,0 0,1,0,0,0 -0.4,0,1,-1.1,0 0,0,0,1,0" in="SourceGraphic" /> </filter> </defs> </svg>';
