...
filtreID.innerHTML = '<svg id="colorblind-filters" style="display: none"> <defs> <filter id="Deuteranopia"> <feColorMatrix type="matrix" values="1,0,0,0,0 0.9,0,0,0,0 -0.2,1.2,1,0,0 0,0,0,1,0" in="SourceGraphic" /> </filter> </defs> </svg>';
